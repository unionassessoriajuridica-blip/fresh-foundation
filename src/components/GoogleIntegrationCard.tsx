              ...
              {permissions.map((permission, index) => {
                ...
                return (
                  <div key={index} className="flex items-center gap-3 p-2 bg-white rounded-lg border border-green-200">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium text-green-800">{permission.title}</p>
    ...
    <Card className="w-full max-w-md mx-auto">
      <CardHeader>
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-muted-foreground">Integre seu Gmail e Google Calendar</p>
          </div>
        </div>
      </CardHeader>
      ...
      <CardContent className="space-y-4">
        <div className="flex items-start gap-2 p-3 bg-blue-50 rounded-lg border border-blue-200">
          ...
          <div>
            <p className="text-sm font-medium text-blue-800">Segurança e Privacidade</p>
