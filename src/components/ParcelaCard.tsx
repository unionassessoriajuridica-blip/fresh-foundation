  ...
  return (
    <div
      className={`border rounded-lg p-4 transition-all hover:shadow-md ${
        isVencido(vencimento, status) ? 'border-red-200 bg-red-50 dark:border-red-800 dark:bg-red-950' : 'bg-background'
      }`}
    >
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    Confirma o recebimento de <strong>{formatCurrency(valor)}</strong> de{' '}
